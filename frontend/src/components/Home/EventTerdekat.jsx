  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-8">
      <div className="flex justify-between items-center mb-5">
        ...
        <button className="border border-black rounded-md px-5 py-2 font-medium text-black text-sm w-[95px] transition hover:bg-black hover:text-white active:scale-90 duration-300">
          View All
        </button>
      </div>
